...
if __name__ == "__main__":
    dml_instance = DML()
    raw_data: Tuple = None
    condition = f" game_uid not in (select distinct(game_uid) from new_events)"
    ...
    for count, game_uid in tqdm(enumerate(reversed(game_uids))):
        ...
        try:
            ...
            try:
                ...
                weather = "Unknown"
            batter_sql = "insert into new_events(player_type, player_uid, date, game_uid, season, weather, opponent_uid, event_index, event, event_type, player_main_position, opponent_hand, rbi, strikes, balls, outs, inning, is_top_inning) values(%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            pitcher_sql = "insert into new_events(player_type, player_uid, date, game_uid, season, weather, opponent_uid, event_index, event, event_type, player_main_position, opponent_hand, rbi, strikes, balls, outs, inning, is_top_inning) values(%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            ...
            for index in range(all_plays_len):
                ...
                batter_val_list.append(('batters', batter_id, date, game_uid, season, weather, pitcher_id, event_index, event,
                                        event_type, player_main_position, pitcher_hand, rbi, strikes, balls, outs, inning,
                                        is_top_inning))

                pitcher_val_list.append(('pitchers', pitcher_id, date, game_uid, season, weather, batter_id, event_index, event,
